      ...
      <div className="container px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold mb-6">
            <EditableText id="testimonials_title_1" defaultText="Lo que dicen nuestros" />{" "}
            <span className="gradient-text"><EditableText id="testimonials_title_2" defaultText="clientes" /></span>
          </h2>
          <p className="text-lg text-muted-foreground">
            <EditableText id="testimonials_subtitle" defaultText="Empresas que ya confían en Localix para gestionar sus operaciones." />
          </p>
        </div>
          ...
          {testimonials.map((testimonial, index) => (
            ...
            >
              ...
              <p className="text-muted-foreground mb-6 leading-relaxed">
                "<EditableText id={`testimonial_content_${index}`} defaultText={testimonial.content} />"
              </p>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="font-semibold">
                    <EditableText id={`testimonial_name_${index}`} defaultText={testimonial.name} />
                  </div>
                  <div className="text-sm text-muted-foreground">
                    <EditableText id={`testimonial_role_${index}`} defaultText={testimonial.role} />
                  </div>
                </div>
              </div>
            </div>

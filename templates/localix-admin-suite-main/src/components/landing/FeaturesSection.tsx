      ...
      <div className="container px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold mb-6">
            <EditableText id="features_title_1" defaultText="Todo lo que necesitas para" />{" "}
            <span className="gradient-text"><EditableText id="features_title_2" defaultText="gestionar tu negocio" /></span>
          </h2>
          <p className="text-lg text-muted-foreground">
            <EditableText id="features_subtitle" defaultText="Herramientas poderosas diseñadas para maximizar tu productividad y control." />
          </p>
        </div>
          ...
          {features.map((feature, index) => (
            ...
            >
              ...
              <h3 className="text-xl font-semibold mb-2">
                <EditableText id={`feature_title_${index}`} defaultText={feature.title} />
              </h3>
              <p className="text-muted-foreground">
                <EditableText id={`feature_desc_${index}`} defaultText={feature.description} />
              </p>
            </div>
          ))}
        </div>

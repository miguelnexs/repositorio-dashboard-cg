      ...
      <div className="container relative z-10 px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-4xl mx-auto mb-12">
          ...
          <div className="animate-fade-up inline-flex items-center gap-2 px-4 py-2 rounded-full glass-card mb-8">
            ...
            <span className="text-sm text-muted-foreground">Dashboard Administrativo v1.0</span>
          </div>
          ...
          <p className="animate-fade-up-delay-2 text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto mb-10">
            Centraliza estadísticas, ventas, clientes y productos en una sola pantalla. 
            Métricas en tiempo real con actualización automática cada 3 segundos.
          </p>
